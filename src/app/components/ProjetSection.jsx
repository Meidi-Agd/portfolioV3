...
const ProjetSection = () => {
    return (
        <section className="text-white mt-12 mb-12 h-[70vh] md:h-[80vh] flex flex-col justify-evenly items-center" id="projets">
            <h2 className="text-center text-5xl font-bold text-white mb-4 md:underline">Mes Projets</h2>

            <div className="w-full h-[95%] border-4 border-[#917FB3] rounded-3xl flex justify-center items-center">
                <Swiper
                    slidesPerView={1}
                    spaceBetween={2}
                    pagination={{
